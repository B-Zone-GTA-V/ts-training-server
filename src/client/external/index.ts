...
export namespace ExternalPackages {
    ...
    let menuRoupasItem1, menuRoupasItem2, menuRoupasItem3, menuRoupasItem4, menuRoupasItem5, menuRoupasItem6, menuRoupasItem7, menuRoupasItem8, menuRoupasItem9, menuRoupasItem10;
    let mascarasTextureNewArray, chapeusTextureNewArray, jaquetasTextureNewArray, camisasTextureNewArray, calcasTextureNewArray, sapatosTextureNewArray, maosTextureNewArray, oculosTextureNewArray, acessoriosTextureNewArray, mochilasTextureNewArray;
    ...
    const menuRoupasMascaras: any = new Menu("Masks", "", new Point(50, 50));
    ...
    menuRoupasMascaras.ListChange.on((item: any, _: any) => {
    ...
    const menuRoupasJaquetas: any = new Menu("Jackets", "", new Point(50, 50));
    ...
    menuRoupasJaquetas.ListChange.on((item: any, _: any) => {
    ...
    const menuRoupasCamisas: any = new Menu("Shirts", "", new Point(50, 50));
    ...
    menuRoupasCamisas.ListChange.on((item: any, _: any) => {
    ...
    const menuRoupasCalcas: any = new Menu("Legs", "", new Point(50, 50));
    ...
    menuRoupasCalcas.ListChange.on((item: any, _: any) => {
    ...
    const menuRoupasSapatos: any = new Menu("Shoes", "", new Point(50, 50));
    ...
    menuRoupasSapatos.ListChange.on((item: any, _: any) => {
    ...
    const menuRoupasMaos: any = new Menu("Hands", "", new Point(50, 50));
    ...
    menuRoupasMaos.ListChange.on((item: any, _: any) => {
    ...
    const menuRoupasOculos: any = new Menu("Glasses", "", new Point(50, 50));
    ...
    menuRoupasOculos.ListChange.on((item: any, _: any) => {
    ...
    const menuRoupasAcessorios: any = new Menu("Acessories", "", new Point(50, 50));
    ...
    menuRoupasAcessorios.ListChange.on((item: any, _: any) => {
    ...
    const menuRoupasMochilas: any = new Menu("Bags", "", new Point(50, 50));
    ...
    menuRoupasMochilas.ListChange.on((item: any, _: any) => {
