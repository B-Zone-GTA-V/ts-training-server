...
export default class UIMenuDynamicListItem extends UIMenuItem {
	...
	set PreCaptionText(text: string) {
		...
		this._preText = text;
		this.currOffset = UiScreen.GetTextWidth(this.PreCaptionText + this._value.toString(), this._itemText && this._itemText.font ? this._itemText.font : 0, 0.35, ResText); // this._itemText && this._itemText.scale ? this._itemText.scale : 0.35
	}
	...
	set SelectedValue(value: number) {
		...
		this.currOffset = UiScreen.GetTextWidth(this.PreCaptionText + this._value.toString(), this._itemText && this._itemText.font ? this._itemText.font : 0, this._itemText && this._itemText.scale ? this._itemText.scale : 0.35, ResText);
	}
