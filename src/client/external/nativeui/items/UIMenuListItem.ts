	...
	set Index(value) {
		...
		const caption =
			this.Collection.length >= this.Index
				...
				: " ";
		this.currOffset = UiScreen.GetTextWidth(caption, this._itemText && this._itemText.font ? this._itemText.font : 0, 0.35, ResText); // this._itemText && this._itemText.font ? this._itemText.font : 0, this._itemText && this._itemText.scale ? this._itemText.scale : 0.35
	}
