export enum cayoPericoNative {
    ...
    SET_AI_GLBOAL_PATH_NODES_TYPE = '0xF74B1FFA4A15FBEA',
...
export const islandInteriorProps = [
    { 
        coords: new mp.Vector3(4969.689, -5286.237, 6.293),
        type: 'uj_cayo_barracks',
        props: ['box'] 
    },
    { 
        coords: new mp.Vector3(5130.676, -4611.803, -4.666),
        type: 'int_stock',
        props: [
            'light_stock', 
            'meth_app', 
            ...
            'meth_update_lab_01',
            'meth_update_lab_02', 
            'meth_update_lab_01_2', 
            'meth_update_lab_02_2', 
            'meth_stock'
        ] 
    },
    { 
        coords: new mp.Vector3(5134.326, -5190.307, -4.675), 
        type: 'int_stock',
        props: [
            'weed_app',
            'weed_staff_01',
    ...
    { 
        coords: new mp.Vector3(4983.767, -5133.899, -4.474),
        type: 'int_stock',
        props: [
            'light_stock',
            'coke_app',
    ...
    { 
        coords: new mp.Vector3(4906.630, -5279.436, -1.376),
        type: 'int_stock',
        props: [
            'light_stock', 
            'money_app',
    ...
    { 
        coords: new mp.Vector3(4986.189, -5295.240, -0.818), 
        type: 'int_stock', 
        props: [
            'light_stock', 
            'weapon_app', 
